...
- MCP 默认连接 demos.03_mcp.server（天气）；可通过环境变量 MCP_SERVER_MODULE 等覆盖。
- 运行：在项目根目录执行 python -m demos.12_chat_app.app，然后打开 http://127.0.0.1:5000
"""
