...
| 09_eval | 评估与评测 |
| 10_multimodal | 多模态 |
| 11_skill | Skill 学习与示例（SKILL.md / demo-skill） |
...
依赖：`core.llm`、`core.rag_doc`（见项目根 requirements.txt）。**12_chat_app** 为独立 Web 应用，运行 `python -m demos.12_chat_app.app` 后访问 http://127.0.0.1:5000。
